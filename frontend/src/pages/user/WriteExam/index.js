          ...
          <div className='flex flex-col gap-2 mt-2'>
            ...
            <div className='flex flex-col gap-2'>
              {Object.keys(questions[selectedQuestionIndex].options).map((option, index) => {
                return (
                  <div
                    className={`flex gap-2 items-center ${selectedOptions[selectedQuestionIndex] === option ? "selected-option" : "option"}`}
                    key={index}
                    onClick={() => {
                      setSelectedOptions(prev => ({ ...prev, [selectedQuestionIndex]: option }))
                    }}
                  >
        ...
        {view === "review" && (
          <div className='flex flex-col gap-2'>
            {questions.map((question, index) => {
              ...
              return (
                <div className={`flex flex-col gap-1 p-2 card ${isCorrect ? "bg-success" : "bg-warning"}`} key={index}>
