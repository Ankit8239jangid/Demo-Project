...
function Instructions(props) {
  ...
  const handleClose = () => {
    // If no previous page exists, navigate to a default route like home
    navigate(-1) || navigate('/'); // Navigate backward or to the home page
  };
  ...
  return (
    <div className='flex flex-col items-center mt-2 gap-5'>
      ...
      <ul className='flex flex-col gap-1'>
        ...
        <li>
          Do not refresh the page and do not navigate to other pages like Home, Profile. If you do so, you'll have to restart your exam.
        </li>
        <li>
      ...
      <div className='flex gap-2'>
        <button className='primary-outlined-btn' onClick={handleClose}>
          Close
        </button>
        <button
